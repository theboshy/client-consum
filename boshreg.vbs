...
Dim objReg,objFSO,objFile,currentFolder
Set objFSO = CreateObject("Scripting.FileSystemObject")
Set objFile = objFSO.GetFile(Wscript.ScriptFullName)
Set objReg=GetObject("winmgmts:{impersonationLevel=impersonate}!\\.\root\default:StdRegProv")
currentFolder = objFSO.GetParentFolderName(objFile)

RegWrite "HKLM\Software\Classes\conecproto", "", "REG_SZ", "URL:TwainBDirect"
RegWrite "HKLM\Software\Classes\conecproto", "URL Protocol", "REG_SZ", ""
RegWrite "HKLM\Software\Classes\conecproto\DefaultIcon", "", "REG_SZ", "conecproto.exe,1"
RegWrite "HKLM\Software\Classes\conecproto\shell\open\command", "", "REG_SZ", "WSCRIPT """&currentFolder&"\ejeinterproto.vbs"""
